(function () {
  ...
  function drawBird(ctx, x, y, size, velocity) {
    ...
    ctx.lineTo(-5, 10);
    ctx.quadraticCurveTo(3, 15, 12, 8);
    ctx.quadraticCurveTo(16, 2, 11, -5);
    ctx.quadraticCurveTo(3, -13, -7, -9);
    ctx.quadraticCurveTo(-14, -6, -14, 8);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();

    ctx.fillStyle = '#d28a4f';
    ctx.beginPath();
    ctx.moveTo(-9, -7);
    ctx.quadraticCurveTo(-4, -17, 1, -15);
    ctx.quadraticCurveTo(1, -8, -3, -3);
    ctx.closePath();
    ctx.fill();
    ctx.stroke();
    ...
    ctx.beginPath();
    ctx.ellipse(7, -1, 7, 5, -0.15, 0, Math.PI * 2);
    ctx.fill();
    ctx.stroke();
